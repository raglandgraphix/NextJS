            ...
            for (let j = 0; j < NumberofColumns; j++) {
                ...
                if(ColorArray){
                    if (colorIndex < ColorArray.length) {
                        ...
                        <td className="pt-3 ps-3 border TextureColor" key={colorIndex}  ><Link className="text-decoration-none text-black ms-3 " key={colorIndex} href={`/${Product}/Colors/${ColorArray[colorIndex]}-${Texture}`}>{ColorArray[colorIndex].replaceAll(/_/g,' ')}</Link></td>
